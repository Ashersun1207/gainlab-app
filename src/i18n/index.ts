...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    settings_agent_model: '模型偏好',
    settings_agent_style: '分析风格',
    settings_agent_auto: '切换标的自动分析',
    settings_style_concise: '简洁',
    settings_style_detailed: '详细',
    settings_style_technical: '技术面',
    settings_style_fundamental: '基本面',
  ...
  en: {
    ...
    settings_agent_model: 'Model Preference',
    settings_agent_style: 'Analysis Style',
    settings_agent_auto: 'Auto-analyze on Switch',
    settings_style_concise: 'Concise',
    settings_style_detailed: 'Detailed',
    settings_style_technical: 'Technical',
    settings_style_fundamental: 'Fundamental',
