 ...
 * line type
 */
export type LineType = 'dashed' | 'solid' | 'dotted'
...
export interface CandleStyle {
  ...
  footprintPeriod: CandleFootprintPeriodStyle
...
export interface CandleFootprintPeriodStyle {
  dataKey: string
  barWidthMultiplier: number
  gapMultiplier: number
  buyColor: string
...
function getDefaultCandleStyle (): CandleStyle {
  ...
  return {
    ...
    footprint: {
      ...
      pocHighlightColor: 'rgba(0, 118, 255, 0.2)',
